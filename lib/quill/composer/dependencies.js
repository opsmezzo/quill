...
//
// Filter scripts for all systems in the specified `runlist` to
// exclude any scripts which are extraneous for the `action` or
// that have already been run based on the local history.
//
